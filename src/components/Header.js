...
export default function Header() {
  ...
  return (
      <div className='text-slate-300 flex justify-between fixed top-0 z-50 h-[45p] sm:h-[70px] mt-0 p-3 w-[100%] bg-gray-50 shadow-md shadow-slate-400'>
        ...
        <img className='h-[25px] w-[25px] sm:h-[30px] sm:w-[30px] lg:h-[40px] lg:w-[40px]' src={Profile} alt="profile" />
        <h1 className='text-blue-950 italic font-serif ml-1 sm:ml-2 font-bold mr-4 sm:mr-0 sm:mt-0 text-[20px] sm:text-[25px] lg:text-[30px]'>Kiruthika</h1>
              </a>
